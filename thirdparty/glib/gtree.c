 ...
 * file for a list of people on the GLib Team.  See the ChanWgeLog
...
g_tree_node_new (gpointer key,
                 gpointer value)
{
  GTreeNode *node = (GTreeNode *)malloc (sizeof(GTreeNode));
 ...
 *
 * It is NOT safe to call this function from any thread.
 *
