               ...
               gpointer  data)
{
  ...
  new_list = (GList *)malloc(sizeof(GList));//_g_list_alloc ();
  new_list->data = data;
  new_list->next = NULL;
  ...
  if (!list)
    {
      list = g_list_alloc ();
      list->data = data;
      //g_return_val_if_fail (sibling == NULL, list); // ??? list is returned in both cases
      return list;
    }
  else if (sibling)
    {
      ...
      node = (GList *)malloc(sizeof(GList));//_g_list_alloc ();
      node->data = data;
  ...
  else
    {
      ...
      last->next = (GList *)malloc(sizeof(GList));//_g_list_alloc ();
      last->next->data = data;
      last->next->prev = last;
      last->next->next = NULL;
                           ...
                           gpointer  user_data)
{
  ...
  if (!list) 
    {
      new_list = (GList *)malloc(sizeof(GList));//_g_list_alloc0 ();
