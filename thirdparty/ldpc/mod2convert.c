...
/**
 * @brief CONVERT A MOD2 MATRIX FROM SPARSE TO DENSE FORM.
 *
 * @param m  Sparse matrix to convert
 * @param r  Place to store result
 */

void mod2sparse_to_dense(mod2sparse *m, mod2dense *r)
{
    mod2entry *e;
    int i;
...
/**
 * @param CONVERT A MOD2 MATRIX FROM DENSE TO SPARSE FORM.
 *
 * @parma m  Dense matrix to convert
 * @parma r  Place to store result
 */

void mod2dense_to_sparse(mod2dense *m, mod2sparse *r)
{
    int i, j;
