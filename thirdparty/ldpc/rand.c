...
/**
 * @brief INITIALIZE MODULE.  Sets things up using the default state structure,
...
/**
 * @brief SET CURRENT STATE ACCORDING TO SEED.
 *
 * @param seed
 */
...
/**
 * @brief SET STATE STRUCTURE TO USE.
 *
 * @param st    state
 */
...
/**
 * @brief RETURN POINTER TO CURRENT STATE.
 *
...
/**
 *  @brief GENERATE RANDOM 31-BIT INTEGER.  Not really meant for use outside this
 * module. 
 *
 * @return random value
 */
...
/**
 * @brief GENERATE UNIFORMLY FROM [0,1).
 *
 * @return random value
 */
...
/**
 * @brief GENERATE UNIFORMLY FORM (0,1).
 *
 * @return random value
 */
...
/**
 * @brief GENERATE RANDOM INTEGER FROM 0, 1, ..., (n-1).
 *
...
/**
 * @brief GENERATE INTEGER FROM 0, 1, ..., (n-1), WITH GIVEN DISTRIBUTION.
 *
 * @param n      scale factor
...
/**
 * @brief GENERATE RANDOM PERMUTATION OF INTEGERS FROM 1 TO N.
 *
 * @param perm          Place to store permutation
 * @param n	            Number of integers to permute 
 */

void rand_permutation(int *perm, int n)
{
    int i, j, t;
...
/**
 * @brief POISSON GENERATOR.  The method used is simple, but not very fast.  See
...
/**
 * @brief GAUSSIAN GENERATOR.  Done by using the Box-Muller method, but only one
...
/**
 * @brief EXPONENTIAL GENERATOR.  See Devroye, p. 29.  Written so as to never
 * return exactly zero. 
 *
 * @return random value
 */
...
/**
 * @brief LOGISTIC GENERATOR.  Just inverts the CDF. 
 *
 * @return random value
 */
...
/**
 * @brief CAUCHY GENERATOR.  See Devroye, p. 29.
 *
 * @return random value
 */
...
/**
 * @brief GAMMA GENERATOR.  Generates a positive real number, r, with density
...
/**
 * @brief BETA GENERATOR. Generates a real number, r, in (0,1), with density
